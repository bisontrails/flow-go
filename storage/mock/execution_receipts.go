...
// Add2IndexAllBlockReceipts provides a mock function with given fields: receipt
func (_m *ExecutionReceipts) Add2IndexAllBlockReceipts(receipt *flow.ExecutionReceipt) error {
...
// GetAllBlockReceipts provides a mock function with given fields: blockID
func (_m *ExecutionReceipts) GetAllBlockReceipts(blockID flow.Identifier) ([]*flow.ExecutionReceipt, error) {
	ret := _m.Called(blockID)
